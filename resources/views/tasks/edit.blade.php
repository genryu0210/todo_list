                ...
                <form action="/tasks/{{ $task->id }}" method="post" class="mt-10">
                    ...
                    <div class="flex flex-col items-center">
                        <label class="w-full max-w-3xl mx-auto">
                            <input class="placeholder:italic placeholder:text-slate-400 block bg-white w-full border border-slate-300 rounded-md py-4 pl-4 shadow-sm focus:outline-none focus:border-sky-500 focus:ring-sky-500 focus:ring-1 sm:text-sm" 
                        ...
                        <div class="mt-8 w-full flex items-center justify-center gap-10">
                            ...
                            <button type="submit" class="p-4 bg-slate-800 text-white w-full max-w-xs hover:bg-slate-900 transition-colors">
                                編集する
                            </button>
                        </div>
                    </div>
